...
_Generated: 2026-05-26T11:02:02.966Z_
...
Workspace `mcp.json` _(folder: contact us)_

- **e:\Salma\contact us\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\hp\.claude.json** — _File missing_
